    ...
    def make_instance(self, include_optional) -> ContainerCreateRequest:
        ...
        if include_optional:
            return ContainerCreateRequest(
                ...
                shell = [/bin/sh, -c],
                host_config = None,
                networking_config = {"EndpointsConfig":{"isolated_nw":{"IPAMConfig":{"IPv4Address":"172.20.30.33","IPv6Address":"2001:db8:abcd::3033","LinkLocalIPs":["169.254.34.68","fe80::3468"]},"MacAddress":"02:42:ac:12:05:02","Links":["container_1","container_2"],"Aliases":["server_x","server_y"]},"database_nw":{}}}
            )
        else:
            return ContainerCreateRequest(
        )
