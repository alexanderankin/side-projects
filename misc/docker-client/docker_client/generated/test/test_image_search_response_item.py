...
class TestImageSearchResponseItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ImageSearchResponseItem:
        """Test ImageSearchResponseItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageSearchResponseItem`
        """
        model = ImageSearchResponseItem()
        if include_optional:
    ...
    def testImageSearchResponseItem(self):
        """Test ImageSearchResponseItem"""
