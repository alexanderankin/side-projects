...
class TestClusterVolumePublishStatusInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterVolumePublishStatusInner:
        """Test ClusterVolumePublishStatusInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterVolumePublishStatusInner`
        """
        model = ClusterVolumePublishStatusInner()
        if include_optional:
    ...
    def testClusterVolumePublishStatusInner(self):
        """Test ClusterVolumePublishStatusInner"""
