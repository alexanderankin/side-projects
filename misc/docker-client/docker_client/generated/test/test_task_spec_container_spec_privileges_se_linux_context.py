...
class TestTaskSpecContainerSpecPrivilegesSELinuxContext(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TaskSpecContainerSpecPrivilegesSELinuxContext:
        """Test TaskSpecContainerSpecPrivilegesSELinuxContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskSpecContainerSpecPrivilegesSELinuxContext`
        """
        model = TaskSpecContainerSpecPrivilegesSELinuxContext()
        if include_optional:
    ...
    def testTaskSpecContainerSpecPrivilegesSELinuxContext(self):
        """Test TaskSpecContainerSpecPrivilegesSELinuxContext"""
