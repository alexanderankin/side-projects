...
class TestImageInspectRootFS(unittest.TestCase):
    """ImageInspectRootFS unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageInspectRootFS:
        """Test ImageInspectRootFS
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageInspectRootFS`
        """
        model = ImageInspectRootFS()
        if include_optional:
    ...
    def testImageInspectRootFS(self):
        """Test ImageInspectRootFS"""
