...
class TestSwarmSpecTaskDefaults(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SwarmSpecTaskDefaults:
        """Test SwarmSpecTaskDefaults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwarmSpecTaskDefaults`
        """
        model = SwarmSpecTaskDefaults()
        if include_optional:
    ...
    def testSwarmSpecTaskDefaults(self):
        """Test SwarmSpecTaskDefaults"""
