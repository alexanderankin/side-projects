...
class TestImageApi(unittest.TestCase):
    ...
    def test_build_prune(self) -> None:
    ...
    def test_image_build(self) -> None:
    ...
    def test_image_commit(self) -> None:
    ...
    def test_image_get_all(self) -> None:
    ...
    def test_image_inspect(self) -> None:
    ...
    def test_image_prune(self) -> None:
