...
class TestTaskSpecContainerSpecPrivilegesAppArmor(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TaskSpecContainerSpecPrivilegesAppArmor:
        """Test TaskSpecContainerSpecPrivilegesAppArmor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskSpecContainerSpecPrivilegesAppArmor`
        """
        model = TaskSpecContainerSpecPrivilegesAppArmor()
        if include_optional:
    ...
    def testTaskSpecContainerSpecPrivilegesAppArmor(self):
        """Test TaskSpecContainerSpecPrivilegesAppArmor"""
