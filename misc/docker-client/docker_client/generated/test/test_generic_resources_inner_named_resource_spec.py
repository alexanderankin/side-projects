...
class TestGenericResourcesInnerNamedResourceSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GenericResourcesInnerNamedResourceSpec:
        """Test GenericResourcesInnerNamedResourceSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenericResourcesInnerNamedResourceSpec`
        """
        model = GenericResourcesInnerNamedResourceSpec()
        if include_optional:
    ...
    def testGenericResourcesInnerNamedResourceSpec(self):
        """Test GenericResourcesInnerNamedResourceSpec"""
