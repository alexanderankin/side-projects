...
class TestContainerSummaryHostConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContainerSummaryHostConfig:
        """Test ContainerSummaryHostConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContainerSummaryHostConfig`
        """
        model = ContainerSummaryHostConfig()
        if include_optional:
    ...
    def testContainerSummaryHostConfig(self):
        """Test ContainerSummaryHostConfig"""
