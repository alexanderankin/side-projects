        ...
        if include_optional:
            return Secret(
                ...
                version = docker_client.generated.models.object_version.ObjectVersion(
                    index = 373531, ),
                created_at = '2017-07-20T13:55:28.678958722Z',
                updated_at = '2017-07-20T13:55:28.678958722Z',
                spec = docker_client.generated.models.secret_spec.SecretSpec(
                    name = '', 
                    labels = {"com.example.some-label":"some-value","com.example.some-other-label":"some-other-value"}, 
                    data = '', 
                    driver = docker_client.generated.models.driver.Driver(
                        name = 'some-driver', 
                        options = {"OptionA":"value for driver-specific option A","OptionB":"value for driver-specific option B"}, ), 
                    templating = docker_client.generated.models.driver.Driver(
                        name = 'some-driver', 
                        options = {"OptionA":"value for driver-specific option A","OptionB":"value for driver-specific option B"}, ), )
            )
        else:
