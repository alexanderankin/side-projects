...
class TestCreateImageInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateImageInfo:
        """Test CreateImageInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateImageInfo`
        """
        ...
        if include_optional:
            return CreateImageInfo(
                id = '',
                error = '',
                error_detail = docker_client.generated.models.error_detail.ErrorDetail(
                    code = 56, 
                    message = '', ),
                status = '',
                progress = '',
                progress_detail = docker_client.generated.models.progress_detail.ProgressDetail(
                    current = 56, 
                    total = 56, )
            )
        else:
