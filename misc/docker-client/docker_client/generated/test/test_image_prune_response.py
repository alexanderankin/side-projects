...
class TestImagePruneResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ImagePruneResponse:
        """Test ImagePruneResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImagePruneResponse`
        """
        model = ImagePruneResponse()
        if include_optional:
            return ImagePruneResponse(
                images_deleted = [
                    docker_client.generated.models.image_delete_response_item.ImageDeleteResponseItem(
                        untagged = '', 
                        deleted = '', )
                    ],
                space_reclaimed = 56
    ...
    def testImagePruneResponse(self):
        """Test ImagePruneResponse"""
