...
class TestHistoryResponseItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HistoryResponseItem:
        """Test HistoryResponseItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HistoryResponseItem`
        """
        model = HistoryResponseItem()
        if include_optional:
    ...
    def testHistoryResponseItem(self):
        """Test HistoryResponseItem"""
