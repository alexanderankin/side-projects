...
class TestSystemInfoDefaultAddressPoolsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SystemInfoDefaultAddressPoolsInner:
        """Test SystemInfoDefaultAddressPoolsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemInfoDefaultAddressPoolsInner`
        """
        model = SystemInfoDefaultAddressPoolsInner()
        if include_optional:
            return SystemInfoDefaultAddressPoolsInner(
                base = '10.10.0.0/16',
                size = 24
            )
        else:
    ...
    def testSystemInfoDefaultAddressPoolsInner(self):
        """Test SystemInfoDefaultAddressPoolsInner"""
