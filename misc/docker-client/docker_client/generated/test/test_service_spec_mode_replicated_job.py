...
class TestServiceSpecModeReplicatedJob(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServiceSpecModeReplicatedJob:
        """Test ServiceSpecModeReplicatedJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceSpecModeReplicatedJob`
        """
        model = ServiceSpecModeReplicatedJob()
        if include_optional:
    ...
    def testServiceSpecModeReplicatedJob(self):
        """Test ServiceSpecModeReplicatedJob"""
