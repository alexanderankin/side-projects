...
class TestSwarmSpecTaskDefaultsLogDriver(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SwarmSpecTaskDefaultsLogDriver:
        """Test SwarmSpecTaskDefaultsLogDriver
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwarmSpecTaskDefaultsLogDriver`
        """
        model = SwarmSpecTaskDefaultsLogDriver()
        if include_optional:
    ...
    def testSwarmSpecTaskDefaultsLogDriver(self):
        """Test SwarmSpecTaskDefaultsLogDriver"""
