...
class TestTaskSpecContainerSpecPrivilegesSeccomp(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TaskSpecContainerSpecPrivilegesSeccomp:
        """Test TaskSpecContainerSpecPrivilegesSeccomp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskSpecContainerSpecPrivilegesSeccomp`
        """
        model = TaskSpecContainerSpecPrivilegesSeccomp()
        if include_optional:
    ...
    def testTaskSpecContainerSpecPrivilegesSeccomp(self):
        """Test TaskSpecContainerSpecPrivilegesSeccomp"""
