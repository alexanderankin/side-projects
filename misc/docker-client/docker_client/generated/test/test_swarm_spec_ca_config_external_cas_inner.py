...
class TestSwarmSpecCAConfigExternalCAsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SwarmSpecCAConfigExternalCAsInner:
        """Test SwarmSpecCAConfigExternalCAsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwarmSpecCAConfigExternalCAsInner`
        """
        model = SwarmSpecCAConfigExternalCAsInner()
        if include_optional:
    ...
    def testSwarmSpecCAConfigExternalCAsInner(self):
        """Test SwarmSpecCAConfigExternalCAsInner"""
