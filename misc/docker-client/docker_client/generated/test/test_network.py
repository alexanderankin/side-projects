    ...
    def make_instance(self, include_optional) -> Network:
        ...
        if include_optional:
            return Network(
                ...
                driver = 'overlay',
                enable_ipv6 = False,
                ipam = docker_client.generated.models.ipam.IPAM(
                    driver = 'default', 
                    config = [
                        docker_client.generated.models.ipam_config.IPAMConfig(
                ...
                attachable = False,
                ingress = False,
                config_from = docker_client.generated.models.config_reference.ConfigReference(
                    network = 'config_only_network_01', ),
                config_only = True,
                containers = {"19a4d5d687db25203351ed79d478946f861258f018fe384f229f2efa4b23513c":{"Name":"test","EndpointID":"628cadb8bcb92de107b2a1e516cbffe463e321f548feb37697cce00ad694f21a","MacAddress":"02:42:ac:13:00:02","IPv4Address":"172.19.0.2/16","IPv6Address":""}},
                ...
                peers = [
                    docker_client.generated.models.peer_info.PeerInfo(
                        name = '6869d7c1732b', 
                        ip = '10.133.77.91', )
                    ]
            )
