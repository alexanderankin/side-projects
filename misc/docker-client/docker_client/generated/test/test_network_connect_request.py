...
class TestNetworkConnectRequest(unittest.TestCase):
    """NetworkConnectRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkConnectRequest:
        """Test NetworkConnectRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkConnectRequest`
        """
        model = NetworkConnectRequest()
        if include_optional:
            return NetworkConnectRequest(
                container = '',
                endpoint_config = docker_client.generated.models.endpoint_settings.EndpointSettings(
    ...
    def testNetworkConnectRequest(self):
        """Test NetworkConnectRequest"""
