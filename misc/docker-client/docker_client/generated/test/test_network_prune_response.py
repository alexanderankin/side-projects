...
class TestNetworkPruneResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NetworkPruneResponse:
        """Test NetworkPruneResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkPruneResponse`
        """
        model = NetworkPruneResponse()
        if include_optional:
    ...
    def testNetworkPruneResponse(self):
        """Test NetworkPruneResponse"""
