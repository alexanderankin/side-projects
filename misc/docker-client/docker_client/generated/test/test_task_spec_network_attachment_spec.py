...
class TestTaskSpecNetworkAttachmentSpec(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TaskSpecNetworkAttachmentSpec:
        """Test TaskSpecNetworkAttachmentSpec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskSpecNetworkAttachmentSpec`
        """
        model = TaskSpecNetworkAttachmentSpec()
        if include_optional:
    ...
    def testTaskSpecNetworkAttachmentSpec(self):
        """Test TaskSpecNetworkAttachmentSpec"""
