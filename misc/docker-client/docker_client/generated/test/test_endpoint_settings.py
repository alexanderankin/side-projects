...
class TestEndpointSettings(unittest.TestCase):
    """EndpointSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointSettings:
        """Test EndpointSettings
