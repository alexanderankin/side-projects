...
class TestContainerSummaryNetworkSettings(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContainerSummaryNetworkSettings:
        """Test ContainerSummaryNetworkSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContainerSummaryNetworkSettings`
        """
        model = ContainerSummaryNetworkSettings()
        if include_optional:
    ...
    def testContainerSummaryNetworkSettings(self):
        """Test ContainerSummaryNetworkSettings"""
