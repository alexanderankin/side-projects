...
class TestIndexInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IndexInfo:
        """Test IndexInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndexInfo`
        """
        model = IndexInfo()
        if include_optional:
            return IndexInfo(
                name = 'docker.io',
                mirrors = ["https://hub-mirror.corp.example.com:5000/","https://registry-2.docker.io/","https://registry-3.docker.io/"],
                secure = True,
                official = True
            )
        else:
