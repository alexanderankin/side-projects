...
class TestUnlockKeyResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UnlockKeyResponse:
        """Test UnlockKeyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnlockKeyResponse`
        """
        model = UnlockKeyResponse()
        if include_optional:
    ...
    def testUnlockKeyResponse(self):
        """Test UnlockKeyResponse"""
