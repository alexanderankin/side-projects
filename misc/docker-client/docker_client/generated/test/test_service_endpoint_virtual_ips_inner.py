...
class TestServiceEndpointVirtualIPsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServiceEndpointVirtualIPsInner:
        """Test ServiceEndpointVirtualIPsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceEndpointVirtualIPsInner`
        """
        model = ServiceEndpointVirtualIPsInner()
        if include_optional:
            return ServiceEndpointVirtualIPsInner(
                network_id = '',
                addr = ''
            )
        else:
    ...
    def testServiceEndpointVirtualIPsInner(self):
        """Test ServiceEndpointVirtualIPsInner"""
