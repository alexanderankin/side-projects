...
class TestDistributionInspect(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DistributionInspect:
        """Test DistributionInspect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DistributionInspect`
        """
        model = DistributionInspect()
        if include_optional:
            return DistributionInspect(
                descriptor = docker_client.generated.models.oci_descriptor.OCIDescriptor(
                    media_type = 'application/vnd.docker.distribution.manifest.v2+json', 
                    digest = 'sha256:c0537ff6a5218ef531ece93d4984efc99bbf3f7497c0a7726c88e2bb7584dc96', 
                    size = 3987495, ),
                platforms = [
                    docker_client.generated.models.oci_platform.OCIPlatform(
                        architecture = 'arm', 
                        os = 'windows', 
    ...
    def testDistributionInspect(self):
        """Test DistributionInspect"""
