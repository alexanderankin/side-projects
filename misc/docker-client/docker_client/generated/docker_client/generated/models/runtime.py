...
class Runtime(BaseModel):
    ...
    """ # noqa: E501
    path: Optional[StrictStr] = Field(default=None, description="Name and, optional, path, of the OCI executable binary.  If the path is omitted, the daemon searches the host's `$PATH` for the binary and uses the first result. ")
    runtime_args: Optional[List[StrictStr]] = Field(default=None, description="List of command-line arguments to pass to the runtime when invoked. ", alias="runtimeArgs")
    status: Optional[Dict[str, StrictStr]] = Field(default=None, description="Information specific to the runtime.  While this API specification does not define data provided by runtimes, the following well-known properties may be provided by runtimes:  `org.opencontainers.runtime-spec.features`: features structure as defined in the [OCI Runtime Specification](https://github.com/opencontainers/runtime-spec/blob/main/features.md), in a JSON string representation.  <p><br /></p>  > **Note**: The information returned in this field, including the > formatting of values and labels, should not be considered stable, > and may change without notice. ")
    __properties: ClassVar[List[str]] = ["path", "runtimeArgs", "status"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if runtime_args (nullable) is None
        # and model_fields_set contains the field
        if self.runtime_args is None and "runtime_args" in self.model_fields_set:
            _dict['runtimeArgs'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "path": obj.get("path"),
            "runtimeArgs": obj.get("runtimeArgs"),
