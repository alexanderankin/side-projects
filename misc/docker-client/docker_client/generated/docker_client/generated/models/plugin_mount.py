...
class PluginMount(BaseModel):
    ...
    settable: List[StrictStr] = Field(alias="Settable")
    source: StrictStr = Field(alias="Source")
    destination: StrictStr = Field(alias="Destination")
    type: StrictStr = Field(alias="Type")
    options: List[StrictStr] = Field(alias="Options")
    __properties: ClassVar[List[str]] = ["Name", "Description", "Settable", "Source", "Destination", "Type", "Options"]
