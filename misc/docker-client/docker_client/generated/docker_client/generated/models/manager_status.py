...
class ManagerStatus(BaseModel):
    ...
    """ # noqa: E501
    leader: Optional[StrictBool] = Field(default=False, alias="Leader")
    reachability: Optional[Reachability] = Field(default=None, alias="Reachability")
    addr: Optional[StrictStr] = Field(default=None, description="The IP address and port at which the manager is reachable. ", alias="Addr")
    __properties: ClassVar[List[str]] = ["Leader", "Reachability", "Addr"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Leader": obj.get("Leader") if obj.get("Leader") is not None else False,
