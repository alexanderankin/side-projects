...
class ServiceCreateResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the created service.", alias="ID")
    warnings: Optional[List[StrictStr]] = Field(default=None, description="Optional warning message.  FIXME(thaJeztah): this should have \"omitempty\" in the generated type. ", alias="Warnings")
    __properties: ClassVar[List[str]] = ["ID", "Warnings"]
