...
class ClusterVolumeSpecAccessModeAccessibilityRequirements(BaseModel):
    ...
    """ # noqa: E501
    requisite: Optional[List[Dict[str, StrictStr]]] = Field(default=None, description="A list of required topologies, at least one of which the volume must be accessible from. ", alias="Requisite")
    preferred: Optional[List[Dict[str, StrictStr]]] = Field(default=None, description="A list of topologies that the volume should attempt to be provisioned in. ", alias="Preferred")
    __properties: ClassVar[List[str]] = ["Requisite", "Preferred"]
