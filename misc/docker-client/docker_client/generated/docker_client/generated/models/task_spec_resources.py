...
class TaskSpecResources(BaseModel):
    ...
    """ # noqa: E501
    limits: Optional[Limit] = Field(default=None, alias="Limits")
    reservations: Optional[ResourceObject] = Field(default=None, alias="Reservations")
    __properties: ClassVar[List[str]] = ["Limits", "Reservations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Limits": Limit.from_dict(obj["Limits"]) if obj.get("Limits") is not None else None,
            "Reservations": ResourceObject.from_dict(obj["Reservations"]) if obj.get("Reservations") is not None else None
        })
        return _obj
