...
class NetworkCreateResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the created network.", alias="Id")
    warning: Optional[StrictStr] = Field(default=None, alias="Warning")
    __properties: ClassVar[List[str]] = ["Id", "Warning"]
