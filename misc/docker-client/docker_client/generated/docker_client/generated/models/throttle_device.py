...
class ThrottleDevice(BaseModel):
    ...
    ThrottleDevice
    """ # noqa: E501
    path: Optional[StrictStr] = Field(default=None, description="Device path", alias="Path")
    rate: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Rate", alias="Rate")
    __properties: ClassVar[List[str]] = ["Path", "Rate"]
