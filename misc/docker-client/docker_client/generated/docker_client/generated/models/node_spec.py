...
class NodeSpec(BaseModel):
    ...
    NodeSpec
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name for the node.", alias="Name")
    labels: Optional[Dict[str, StrictStr]] = Field(default=None, description="User-defined key/value metadata.", alias="Labels")
    role: Optional[StrictStr] = Field(default=None, description="Role of the node.", alias="Role")
    availability: Optional[StrictStr] = Field(default=None, description="Availability of the node.", alias="Availability")
    __properties: ClassVar[List[str]] = ["Name", "Labels", "Role", "Availability"]
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in set(['worker', 'manager']):
            raise ValueError("must be one of enum values ('worker', 'manager')")
        return value
