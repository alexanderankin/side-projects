...
class SystemInfoDefaultAddressPoolsInner(BaseModel):
    """
    SystemInfoDefaultAddressPoolsInner
    """ # noqa: E501
    base: Optional[StrictStr] = Field(default=None, description="The network address in CIDR format", alias="Base")
    size: Optional[StrictInt] = Field(default=None, description="The network pool size", alias="Size")
    __properties: ClassVar[List[str]] = ["Base", "Size"]
