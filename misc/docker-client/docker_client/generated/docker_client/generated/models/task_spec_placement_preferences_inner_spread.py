...
class TaskSpecPlacementPreferencesInnerSpread(BaseModel):
    """
    TaskSpecPlacementPreferencesInnerSpread
    """ # noqa: E501
    spread_descriptor: Optional[StrictStr] = Field(default=None, description="label descriptor, such as `engine.labels.az`. ", alias="SpreadDescriptor")
    __properties: ClassVar[List[str]] = ["SpreadDescriptor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "SpreadDescriptor": obj.get("SpreadDescriptor")
        })
        return _obj
