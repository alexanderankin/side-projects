...
class TaskSpecContainerSpecPrivilegesSeccomp(BaseModel):
    ...
    profile: Optional[StrictStr] = Field(default=None, description="The custom seccomp profile as a json object", alias="Profile")
    __properties: ClassVar[List[str]] = ["Mode", "Profile"]
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['default', 'unconfined', 'custom']):
            raise ValueError("must be one of enum values ('default', 'unconfined', 'custom')")
        return value
