...
class DistributionInspect(BaseModel):
    ...
    platforms: List[OCIPlatform] = Field(description="An array containing all platforms supported by the image. ", alias="Platforms")
    __properties: ClassVar[List[str]] = ["Descriptor", "Platforms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Descriptor": OCIDescriptor.from_dict(obj["Descriptor"]) if obj.get("Descriptor") is not None else None,
            "Platforms": [OCIPlatform.from_dict(_item) for _item in obj["Platforms"]] if obj.get("Platforms") is not None else None
        })
        return _obj
