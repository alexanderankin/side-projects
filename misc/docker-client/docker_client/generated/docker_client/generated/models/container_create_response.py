...
class ContainerCreateResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The ID of the created container", alias="Id")
    warnings: List[StrictStr] = Field(description="Warnings encountered when creating the container", alias="Warnings")
