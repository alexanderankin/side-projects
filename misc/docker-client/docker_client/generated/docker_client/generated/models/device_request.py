...
class DeviceRequest(BaseModel):
    ...
    capabilities: Optional[List[List[StrictStr]]] = Field(default=None, description="A list of capabilities; an OR list of AND lists of capabilities. ", alias="Capabilities")
    options: Optional[Dict[str, StrictStr]] = Field(default=None, description="Driver-specific options, specified as a key/value pairs. These options are passed directly to the driver. ", alias="Options")
    __properties: ClassVar[List[str]] = ["Driver", "Count", "DeviceIDs", "Capabilities", "Options"]
