...
class ClusterVolumeSpecAccessModeCapacityRange(BaseModel):
    ...
    """ # noqa: E501
    required_bytes: Optional[StrictInt] = Field(default=None, description="The volume must be at least this big. The value of 0 indicates an unspecified minimum ", alias="RequiredBytes")
    limit_bytes: Optional[StrictInt] = Field(default=None, description="The volume must not be bigger than this. The value of 0 indicates an unspecified maximum. ", alias="LimitBytes")
    __properties: ClassVar[List[str]] = ["RequiredBytes", "LimitBytes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "RequiredBytes": obj.get("RequiredBytes"),
