...
class ConfigReference(BaseModel):
    ...
    """ # noqa: E501
    network: Optional[StrictStr] = Field(default=None, description="The name of the config-only network that provides the network's configuration. The specified network must be an existing config-only network. Only network names are allowed, not network IDs. ", alias="Network")
