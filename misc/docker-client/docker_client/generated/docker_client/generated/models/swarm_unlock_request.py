...
class SwarmUnlockRequest(BaseModel):
    """
    SwarmUnlockRequest
    """ # noqa: E501
    unlock_key: Optional[StrictStr] = Field(default=None, description="The swarm's unlock key.", alias="UnlockKey")
    __properties: ClassVar[List[str]] = ["UnlockKey"]
