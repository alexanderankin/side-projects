...
class EngineDescription(BaseModel):
    ...
    """ # noqa: E501
    engine_version: Optional[StrictStr] = Field(default=None, alias="EngineVersion")
    labels: Optional[Dict[str, StrictStr]] = Field(default=None, alias="Labels")
    plugins: Optional[List[EngineDescriptionPluginsInner]] = Field(default=None, alias="Plugins")
    __properties: ClassVar[List[str]] = ["EngineVersion", "Labels", "Plugins"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Plugins": [EngineDescriptionPluginsInner.from_dict(_item) for _item in obj["Plugins"]] if obj.get("Plugins") is not None else None
        })
        return _obj
