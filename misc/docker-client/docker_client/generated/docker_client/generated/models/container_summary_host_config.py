...
class ContainerSummaryHostConfig(BaseModel):
    """
    ContainerSummaryHostConfig
    """ # noqa: E501
    network_mode: Optional[StrictStr] = Field(default=None, alias="NetworkMode")
    __properties: ClassVar[List[str]] = ["NetworkMode"]
