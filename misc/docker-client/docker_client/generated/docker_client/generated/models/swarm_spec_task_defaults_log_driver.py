...
class SwarmSpecTaskDefaultsLogDriver(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The log driver to use as a default for new tasks. ", alias="Name")
    options: Optional[Dict[str, StrictStr]] = Field(default=None, description="Driver-specific options for the selected log driver, specified as key/value pairs. ", alias="Options")
