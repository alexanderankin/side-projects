...
class OCIDescriptor(BaseModel):
    ...
    """ # noqa: E501
    media_type: Optional[StrictStr] = Field(default=None, description="The media type of the object this schema refers to. ", alias="mediaType")
    digest: Optional[StrictStr] = Field(default=None, description="The digest of the targeted content. ")
    size: Optional[StrictInt] = Field(default=None, description="The size in bytes of the blob. ")
    __properties: ClassVar[List[str]] = ["mediaType", "digest", "size"]
