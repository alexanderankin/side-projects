...
class ContainerWaitResponse(BaseModel):
    ...
    """ # noqa: E501
    status_code: StrictInt = Field(description="Exit code of the container", alias="StatusCode")
    error: Optional[ContainerWaitExitError] = Field(default=None, alias="Error")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Error": ContainerWaitExitError.from_dict(obj["Error"]) if obj.get("Error") is not None else None
        })
        return _obj
