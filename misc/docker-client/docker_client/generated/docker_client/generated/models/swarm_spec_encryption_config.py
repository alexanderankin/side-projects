...
class SwarmSpecEncryptionConfig(BaseModel):
    ...
    """ # noqa: E501
    auto_lock_managers: Optional[StrictBool] = Field(default=None, description="If set, generate a key and use it to lock data stored on the managers. ", alias="AutoLockManagers")
    __properties: ClassVar[List[str]] = ["AutoLockManagers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "AutoLockManagers": obj.get("AutoLockManagers")
        })
        return _obj
