...
class VolumeListResponse(BaseModel):
    ...
    """ # noqa: E501
    volumes: Optional[List[Volume]] = Field(default=None, description="List of volumes", alias="Volumes")
    warnings: Optional[List[StrictStr]] = Field(default=None, description="Warnings that occurred when fetching the list of volumes. ", alias="Warnings")
    __properties: ClassVar[List[str]] = ["Volumes", "Warnings"]
