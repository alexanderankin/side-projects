...
class IPAMConfig(BaseModel):
    ...
    gateway: Optional[StrictStr] = Field(default=None, alias="Gateway")
    auxiliary_addresses: Optional[Dict[str, StrictStr]] = Field(default=None, alias="AuxiliaryAddresses")
    __properties: ClassVar[List[str]] = ["Subnet", "IPRange", "Gateway", "AuxiliaryAddresses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AuxiliaryAddresses": obj.get("AuxiliaryAddresses")
        })
        return _obj
