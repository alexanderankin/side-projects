...
class ResourcesBlkioWeightDeviceInner(BaseModel):
    """
    ResourcesBlkioWeightDeviceInner
    """ # noqa: E501
    path: Optional[StrictStr] = Field(default=None, alias="Path")
    weight: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="Weight")
    __properties: ClassVar[List[str]] = ["Path", "Weight"]
