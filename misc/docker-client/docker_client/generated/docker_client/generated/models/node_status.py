...
class NodeStatus(BaseModel):
    ...
    """ # noqa: E501
    state: Optional[NodeState] = Field(default=None, alias="State")
    message: Optional[StrictStr] = Field(default=None, alias="Message")
    addr: Optional[StrictStr] = Field(default=None, description="IP address of the node.", alias="Addr")
    __properties: ClassVar[List[str]] = ["State", "Message", "Addr"]
