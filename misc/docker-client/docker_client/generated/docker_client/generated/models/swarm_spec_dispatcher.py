...
class SwarmSpecDispatcher(BaseModel):
    ...
    """ # noqa: E501
    heartbeat_period: Optional[StrictInt] = Field(default=None, description="The delay for an agent to send a heartbeat to the dispatcher. ", alias="HeartbeatPeriod")
    __properties: ClassVar[List[str]] = ["HeartbeatPeriod"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "HeartbeatPeriod": obj.get("HeartbeatPeriod")
        })
        return _obj
