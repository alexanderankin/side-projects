...
class EndpointIPAMConfig(BaseModel):
    ...
    link_local_ips: Optional[List[StrictStr]] = Field(default=None, alias="LinkLocalIPs")
    __properties: ClassVar[List[str]] = ["IPv4Address", "IPv6Address", "LinkLocalIPs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LinkLocalIPs": obj.get("LinkLocalIPs")
        })
        return _obj
