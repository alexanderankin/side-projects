...
class ServiceSpecMode(BaseModel):
    ...
    """ # noqa: E501
    replicated: Optional[ServiceSpecModeReplicated] = Field(default=None, alias="Replicated")
    var_global: Optional[Dict[str, Any]] = Field(default=None, alias="Global")
    replicated_job: Optional[ServiceSpecModeReplicatedJob] = Field(default=None, alias="ReplicatedJob")
    global_job: Optional[Dict[str, Any]] = Field(default=None, description="The mode used for services which run a task to the completed state on each valid node. ", alias="GlobalJob")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Replicated": ServiceSpecModeReplicated.from_dict(obj["Replicated"]) if obj.get("Replicated") is not None else None,
            "Global": obj.get("Global"),
            "ReplicatedJob": ServiceSpecModeReplicatedJob.from_dict(obj["ReplicatedJob"]) if obj.get("ReplicatedJob") is not None else None,
