...
class SwarmSpecTaskDefaults(BaseModel):
    ...
    """ # noqa: E501
    log_driver: Optional[SwarmSpecTaskDefaultsLogDriver] = Field(default=None, alias="LogDriver")
    __properties: ClassVar[List[str]] = ["LogDriver"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "LogDriver": SwarmSpecTaskDefaultsLogDriver.from_dict(obj["LogDriver"]) if obj.get("LogDriver") is not None else None
        })
        return _obj
