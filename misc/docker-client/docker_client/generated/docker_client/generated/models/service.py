...
class Service(BaseModel):
    ...
    spec: Optional[ServiceSpec] = Field(default=None, alias="Spec")
    endpoint: Optional[ServiceEndpoint] = Field(default=None, alias="Endpoint")
    update_status: Optional[ServiceUpdateStatus] = Field(default=None, alias="UpdateStatus")
    service_status: Optional[ServiceServiceStatus] = Field(default=None, alias="ServiceStatus")
    job_status: Optional[ServiceJobStatus] = Field(default=None, alias="JobStatus")
    __properties: ClassVar[List[str]] = ["ID", "Version", "CreatedAt", "UpdatedAt", "Spec", "Endpoint", "UpdateStatus", "ServiceStatus", "JobStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Spec": ServiceSpec.from_dict(obj["Spec"]) if obj.get("Spec") is not None else None,
            "Endpoint": ServiceEndpoint.from_dict(obj["Endpoint"]) if obj.get("Endpoint") is not None else None,
            "UpdateStatus": ServiceUpdateStatus.from_dict(obj["UpdateStatus"]) if obj.get("UpdateStatus") is not None else None,
            "ServiceStatus": ServiceServiceStatus.from_dict(obj["ServiceStatus"]) if obj.get("ServiceStatus") is not None else None,
            "JobStatus": ServiceJobStatus.from_dict(obj["JobStatus"]) if obj.get("JobStatus") is not None else None
        })
        return _obj
