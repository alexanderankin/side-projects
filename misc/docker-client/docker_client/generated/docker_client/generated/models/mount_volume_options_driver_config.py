...
class MountVolumeOptionsDriverConfig(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the driver to use to create the volume.", alias="Name")
    options: Optional[Dict[str, StrictStr]] = Field(default=None, description="key/value map of driver specific options.", alias="Options")
