...
class TaskSpecPlacementPreferencesInner(BaseModel):
    """
    TaskSpecPlacementPreferencesInner
    """ # noqa: E501
    spread: Optional[TaskSpecPlacementPreferencesInnerSpread] = Field(default=None, alias="Spread")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Spread": TaskSpecPlacementPreferencesInnerSpread.from_dict(obj["Spread"]) if obj.get("Spread") is not None else None
        })
        return _obj
