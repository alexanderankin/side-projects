...
class MountTmpfsOptions(BaseModel):
    ...
    """ # noqa: E501
    size_bytes: Optional[StrictInt] = Field(default=None, description="The size for the tmpfs mount in bytes.", alias="SizeBytes")
    mode: Optional[StrictInt] = Field(default=None, description="The permission mode for the tmpfs mount in an integer.", alias="Mode")
    __properties: ClassVar[List[str]] = ["SizeBytes", "Mode"]
