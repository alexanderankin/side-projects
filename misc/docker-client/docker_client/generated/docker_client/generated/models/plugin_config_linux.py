...
class PluginConfigLinux(BaseModel):
    ...
    PluginConfigLinux
    """ # noqa: E501
    capabilities: List[StrictStr] = Field(alias="Capabilities")
    allow_all_devices: StrictBool = Field(alias="AllowAllDevices")
    devices: List[PluginDevice] = Field(alias="Devices")
    __properties: ClassVar[List[str]] = ["Capabilities", "AllowAllDevices", "Devices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AllowAllDevices": obj.get("AllowAllDevices"),
            "Devices": [PluginDevice.from_dict(_item) for _item in obj["Devices"]] if obj.get("Devices") is not None else None
        })
        return _obj
