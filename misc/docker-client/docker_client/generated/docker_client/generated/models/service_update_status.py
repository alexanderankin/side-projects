...
class ServiceUpdateStatus(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["State", "StartedAt", "CompletedAt", "Message"]
    ...
    def state_validate_enum(cls, value):
        ...
        if value not in set(['updating', 'paused', 'completed']):
            raise ValueError("must be one of enum values ('updating', 'paused', 'completed')")
        return value
