...
class NetworkConnectRequest(BaseModel):
    ...
    """ # noqa: E501
    container: Optional[StrictStr] = Field(default=None, description="The ID or name of the container to connect to the network.", alias="Container")
    endpoint_config: Optional[EndpointSettings] = Field(default=None, alias="EndpointConfig")
    __properties: ClassVar[List[str]] = ["Container", "EndpointConfig"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "EndpointConfig": EndpointSettings.from_dict(obj["EndpointConfig"]) if obj.get("EndpointConfig") is not None else None
        })
        return _obj
