...
class ImageSearchResponseItem(BaseModel):
    ...
    is_automated: Optional[StrictBool] = Field(default=None, description="Whether this repository has automated builds enabled.  <p><br /></p>  > **Deprecated**: This field is deprecated and will always be \"false\". ")
    name: Optional[StrictStr] = None
    star_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["description", "is_official", "is_automated", "name", "star_count"]
