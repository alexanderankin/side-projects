...
class NetworkPruneResponse(BaseModel):
    ...
    """ # noqa: E501
    networks_deleted: Optional[List[StrictStr]] = Field(default=None, description="Networks that were deleted", alias="NetworksDeleted")
    __properties: ClassVar[List[str]] = ["NetworksDeleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "NetworksDeleted": obj.get("NetworksDeleted")
        })
        return _obj
