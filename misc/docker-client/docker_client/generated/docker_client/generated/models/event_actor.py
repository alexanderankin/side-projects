...
class EventActor(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the object emitting the event", alias="ID")
    attributes: Optional[Dict[str, StrictStr]] = Field(default=None, description="Various key/value attributes of the object, depending on its type. ", alias="Attributes")
    __properties: ClassVar[List[str]] = ["ID", "Attributes"]
