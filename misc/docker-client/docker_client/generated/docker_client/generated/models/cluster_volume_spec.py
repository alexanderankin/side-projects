...
class ClusterVolumeSpec(BaseModel):
    ...
    """ # noqa: E501
    group: Optional[StrictStr] = Field(default=None, description="Group defines the volume group of this volume. Volumes belonging to the same group can be referred to by group name when creating Services.  Referring to a volume by group instructs Swarm to treat volumes in that group interchangeably for the purpose of scheduling. Volumes with an empty string for a group technically all belong to the same, emptystring group. ", alias="Group")
    access_mode: Optional[ClusterVolumeSpecAccessMode] = Field(default=None, alias="AccessMode")
    __properties: ClassVar[List[str]] = ["Group", "AccessMode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Group": obj.get("Group"),
            "AccessMode": ClusterVolumeSpecAccessMode.from_dict(obj["AccessMode"]) if obj.get("AccessMode") is not None else None
        })
        return _obj
