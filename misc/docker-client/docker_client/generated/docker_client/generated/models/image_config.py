...
class ImageConfig(BaseModel):
    ...
    """ # noqa: E501
    hostname: Optional[StrictStr] = Field(default=None, description="The hostname to use for the container, as a valid RFC 1123 hostname.  <p><br /></p>  > **Note**: this field is always empty and must not be used. ", alias="Hostname")
    domainname: Optional[StrictStr] = Field(default=None, description="The domain name to use for the container.  <p><br /></p>  > **Note**: this field is always empty and must not be used. ", alias="Domainname")
    user: Optional[StrictStr] = Field(default=None, description="The user that commands are run as inside the container.", alias="User")
    attach_stdin: Optional[StrictBool] = Field(default=False, description="Whether to attach to `stdin`.  <p><br /></p>  > **Note**: this field is always false and must not be used. ", alias="AttachStdin")
    attach_stdout: Optional[StrictBool] = Field(default=False, description="Whether to attach to `stdout`.  <p><br /></p>  > **Note**: this field is always false and must not be used. ", alias="AttachStdout")
    attach_stderr: Optional[StrictBool] = Field(default=False, description="Whether to attach to `stderr`.  <p><br /></p>  > **Note**: this field is always false and must not be used. ", alias="AttachStderr")
    ...
    tty: Optional[StrictBool] = Field(default=False, description="Attach standard streams to a TTY, including `stdin` if it is not closed.  <p><br /></p>  > **Note**: this field is always false and must not be used. ", alias="Tty")
    open_stdin: Optional[StrictBool] = Field(default=False, description="Open `stdin`  <p><br /></p>  > **Note**: this field is always false and must not be used. ", alias="OpenStdin")
    stdin_once: Optional[StrictBool] = Field(default=False, description="Close `stdin` after one attached client disconnects.  <p><br /></p>  > **Note**: this field is always false and must not be used. ", alias="StdinOnce")
    ...
    image: Optional[StrictStr] = Field(default='', description="The name (or reference) of the image to use when creating the container, or which was used when the container was created.  <p><br /></p>  > **Note**: this field is always empty and must not be used. ", alias="Image")
    ...
    network_disabled: Optional[StrictBool] = Field(default=False, description="Disable networking for the container.  <p><br /></p>  > **Note**: this field is always omitted and must not be used. ", alias="NetworkDisabled")
    mac_address: Optional[StrictStr] = Field(default='', description="MAC address of the container.  <p><br /></p>  > **Deprecated**: this field is deprecated in API v1.44 and up. It is always omitted. ", alias="MacAddress")
    ...
    stop_timeout: Optional[StrictInt] = Field(default=None, description="Timeout to stop a container in seconds.  <p><br /></p>  > **Note**: this field is always omitted and must not be used. ", alias="StopTimeout")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "AttachStdout": obj.get("AttachStdout") if obj.get("AttachStdout") is not None else False,
            "AttachStderr": obj.get("AttachStderr") if obj.get("AttachStderr") is not None else False,
            ...
            "NetworkDisabled": obj.get("NetworkDisabled") if obj.get("NetworkDisabled") is not None else False,
            "MacAddress": obj.get("MacAddress") if obj.get("MacAddress") is not None else '',
