...
public enum ProblemDetailAcmeTypes {
    ...
    ProblemDetailAcmeTypes(String detail) {
        problemDetail = new ProblemDetail()
                .setType(URI.create("urn:ietf:params:acme:error:" + name()))
                .setDetail(detail);
    }

    public ProblemDetail getProblemDetail() {
        return new ProblemDetail().setType(problemDetail.getType()).setDetail(problemDetail.getDetail());
    }
}
